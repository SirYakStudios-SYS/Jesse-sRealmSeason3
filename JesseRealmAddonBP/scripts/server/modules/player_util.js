...
class PlayerHandler extends EventEmitter {
        ...
        Server.on('tick', ev => {
            ...
            for (const player of world.getPlayers()) {
                ...
                if (oldDimension && oldDimension != newDimension) {
                    this.emit('playerChangeDimension', player, world.getDimension(newDimension));
                }
            }
        });
    ...
    */
    replaceItem(player, item, sub, locked = false) {
    ...
    */
     ...
     */
    traceForBlock(player, range, mask) {
