...
export function smooth(session, iter, shape, loc, heightMask, mask) {
    ...
    function getMap(arr, x, z) {
        return arr[x]?.[z] ?? null;
    }
    function createMap(sizeX, sizeZ) {
        const arr = [];
